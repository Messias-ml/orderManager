package messiasproject.microservicespecialist.order.core.config.modelMapper;
...
import static messiasproject.microservicespecialist.order.core.config.modelMapper.ModelMapperConfig.modelMapper;
