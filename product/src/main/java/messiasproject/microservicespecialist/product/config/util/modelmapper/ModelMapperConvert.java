package messiasproject.microservicespecialist.product.config.util.modelmapper;

import messiasproject.microservicespecialist.product.domain.exception.ListEmptyException;
...
import static messiasproject.microservicespecialist.product.config.bean.modelmapper.ModelMapperConfig.modelMapper;
